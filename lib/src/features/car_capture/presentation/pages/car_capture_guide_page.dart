...
class _CarCaptureGuidePageState extends State<CarCaptureGuidePage> {
  late final CarCaptureGuideController controller;

  @override
  void initState() {
    super.initState();
    controller = CarCaptureGuideController(
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: AppCheckbox(
                    ...
                    onChanged: (value) => controller.toggleImageSelection(url),
                  ),
                ),
              ],
            ),
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return controller.images.isEmpty
                          ? _buildSampleImage(controller.sampleImages[index])
